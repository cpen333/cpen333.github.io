...
Inside the namespace, the variables `c` and `d` can be accessed normally.  Outside the namespace, however, they must be qualiified with the prefix `cpan333::`.  For example,
```cpp
